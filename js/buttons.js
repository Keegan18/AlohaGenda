...
function WinterChange() {
	...
	EssentialsBro.topBar.style.background = "rgb(88,233,247)"; //styles for top bar 221,246,253 0deg, rgba(221,246,253,1) 0%
	EssentialsBro.topBar.style.background = "linear-gradient(0deg, rgba(221,246,253,1) 0%, rgba(191,250,255,1) 100%"; //styles for top bar rgba(191,250,255,1) 100%
	
	EssentialsBro.calendar.style.background = "rgb(107,242,255)"; //styles for calendar 3,106,182
	EssentialsBro.calendar.style.background = "linear-gradient(0deg, rgba(107,242,255,1) 55%, rgba(69,182,255,1) 71%"; //styles for calendar 
